                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            FoodDetails info = new FoodDetails(dishes, quantity, price, description, uri.toString(), randomUID, merchantId);

                            // Upload the data to Firebase Realtime Database
                            databaseReference.child(merchantId).child(randomUID).setValue(info)
