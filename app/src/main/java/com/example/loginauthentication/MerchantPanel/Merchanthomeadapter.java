...
public class Merchanthomeadapter extends RecyclerView.Adapter<Merchanthomeadapter.ViewHolder>{
    private Context mcont;
    private List<UpdateDishModel>updateDishModellist;

    public Merchanthomeadapter(Context context,List<UpdateDishModel>updateDishModellist)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(view); // Pass the 'view' to the ViewHolder constructor
    }
