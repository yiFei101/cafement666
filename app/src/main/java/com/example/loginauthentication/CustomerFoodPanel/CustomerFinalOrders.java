...
public class CustomerFinalOrders {
    ...
    public CustomerFinalOrders(String merchantId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId) {
